...
class SQLDelightChatDb(
    ...
    override fun getConversationIds(): Flow<List<String>> {
        return flow {
            databaseFactory.withDatabase {
                emitAll(
                    conversationQueries.getConversations()
                        .asFlow()
    ...
    override suspend fun createConversation(conversationId: String): String {
        ...
        databaseFactory.withDatabase {
            conversationQueries.insertConversation(conversationId, timestamp)
        }
    ...
    override suspend fun updateMessageContent(
        ...
        val currentMessages = databaseFactory.withDatabase {
            messageQueries
